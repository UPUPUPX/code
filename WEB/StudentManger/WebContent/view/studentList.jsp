	  ...
	  //设置编辑学生窗口
		...
		$("#search-btn").click(function() {
			$('#dataList').datagrid('load',{
				studentName : $('#search_stu_name').val(),
				clazzid : $("#clazzList").combobox('getValue') == '' ? 0 : $("#clazzList").combobox('getValue')
			});
			 $('#search_stu_name').textbox('setValue','');
			 $("#clazzList").combobox('setValue','');
		});
		//监听图片上传事件(没写完，对于newBeanListHandler获取不到Blob类型)
			...
			setTimeout(function(){
				...
				$("#user_photo").attr("src", "PhotoServlet?method=getPhoto&sid="+$("#set-photo-id").val());
			}, 1500) 
		}); 
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left; margin: 3px 5px 0 5px;">
			姓名：<input id="search_stu_name" class="easyui-textbox"
				name="search_stu_name" />
		</div>
		<div style="float: left;" class="datagrid-btn-separator"></div>
	...
	<div id="addDialog" style="padding: 10px">
		...
		<form id="addForm" method="post">
			<table cellpadding="8">
				...
				<tr>
					<td>密码:</td>
					<td><input id="add_passwordr" class="easyui-textbox"
		...
		<div
			...
			<form id="uploadForm" method="post" enctype="multipart/form-data"
				...
				<input type="hidden" name="sid" id="set-photo-id"> <input
					...
					class="easyui-linkbutton" style="width: 50px; height: 24px;"
