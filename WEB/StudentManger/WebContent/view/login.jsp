...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			this.src="CheckImgServlet?method=checkcode&t="+new Date().getTime();
		});
...
<div class="header" style="padding: 0;">
	<h2 style="color: white; width:100% ; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;" align="center">学生信息管理系统</h2>
</div>
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form id="form" class="form form-horizontal" method="get">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="CheckImgServlet?method=checkcode"></div>
      </div>
...
<div class="footer">xynl &nbsp; pingfan @ pingfan443 </div>
